  ...
  return (
    <div className="space-y-3">
      <label className="block text-sm font-semibold text-gray-700">
        Photo {required && <span style={{ color: '#3686C7' }}>*</span>}
      </label>
      ...
      <div>
        <label className="relative block">
          ...
          <div className={`
            ...
            ${uploading ? 'border-gray-300 bg-gray-50 cursor-not-allowed' : 'border-gray-300 bg-white hover:bg-blue-50'}
          `}
          style={!uploading ? { '--hover-border-color': '#3686C7' } : {}}
          onMouseEnter={(e) => !uploading && (e.currentTarget.style.borderColor = '#3686C7')}
          onMouseLeave={(e) => !uploading && (e.currentTarget.style.borderColor = '')}
          >
            <svg className={`w-6 h-6 ${uploading ? 'text-gray-400' : ''}`} style={!uploading ? { color: '#3686C7' } : {}} fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">

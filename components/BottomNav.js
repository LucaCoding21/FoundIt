    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 safe-area-bottom">
      <div className="max-w-md mx-auto px-8 py-3">
        <div className="flex justify-around items-center">
          ...
          >
            <svg 
              className={`w-7 h-7 ${isActive('/admin/dashboard') ? 'text-gray-700' : 'text-gray-400'}`} 
          ...
          >
            <svg 
              className={`w-7 h-7 ${isActive('/admin/upload') ? 'text-gray-700' : 'text-gray-400'}`}
              fill="none"
              strokeWidth="2"
              stroke="currentColor"
              viewBox="0 0 24 24"
          ...
          >
            <svg 
              className={`w-7 h-7 ${isActive('/admin/reports') ? 'text-gray-700' : 'text-gray-400'}`}
              fill="none"
              strokeWidth="2"
              stroke="currentColor"
              viewBox="0 0 24 24"
